  ...
  render() {
    return (
      <div className="faction-info-modal-container">
        <i className="fas fa-info-circle info-awesome" onClick={this.toggle} data  data-toggle="tooltip" data-placement="top" title="Information for this member"></i>
        <Modal
        ...
        >
          <ModalBody id="faction-info-modal">
            ...
            <p className="faction-info-modal-title">Information of aaa</p>
